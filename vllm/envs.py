...
if TYPE_CHECKING:
    ...
    VLLM_USE_BACKEND_WITH_INDUCTOR_CACHE: bool = False
...
def use_backend_with_cache() -> bool:
    return os.environ.get("VLLM_USE_BACKEND_WITH_INDUCTOR_CACHE", "0") == "1"
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    "VLLM_USE_BACKEND_WITH_INDUCTOR_CACHE": use_backend_with_cache,
